...
import { DropArea, ImageWrapper, DeleteButton } from '@shared/common/image/styles';
...
export default function ImageDropzone(props: Props) {
  ...
  return (
    <Box>
      <DropArea onDrop={handleDrop} onDragOver={handleDragOver} onClick={openFileDialog}>
        <input
          ref={inputRef}
          type="file"
          accept="image/*"
        ...
        <Typography variant="h6">Drag & drop images here, or click to select</Typography>
